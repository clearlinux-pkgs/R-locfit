...
Version  : 1.5.9.5
Release  : 43
URL      : https://cran.r-project.org/src/contrib/locfit_1.5-9.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/locfit_1.5-9.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646333271
