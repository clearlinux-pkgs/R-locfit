...
Version  : 1.5.9.2
Release  : 26
URL      : https://cran.r-project.org/src/contrib/locfit_1.5-9.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/locfit_1.5-9.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584998877
